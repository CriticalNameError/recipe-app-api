...
class PrivateRecipeApiTests(TestCase):
    """Test private Recipe Api functionality"""
    ...
    def test_create_basic_recipe(self):
        ...
        payload = {'title': 'chocolate cheese cake',
                   'time_minutes': 30,
                   'price': 5.0
                   }
    ...
    def test_create_recipe_with_ingrdients(self):
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tag(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Toast Hawaii')
        tag1 = sample_tag(user=self.user, name='Vegan')
